...
public class QuestionService {
    ...
    public Question putMet(Long id, Question books) throws ResourceNotFoundException {
        Question question = findById(id);
        question.setQuestion(books.getQuestion());
        question.setAnswer(books.getAnswer());
        question.setIdSub(books.getIdSub());
